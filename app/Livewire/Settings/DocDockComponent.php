...
class DocDockComponent extends Component
{
    ...
    public function store()
    {
        if ($this->editId) {
            ...
            $response = Http::withToken($this->token)->post('http://192.168.128.193:8080/api/doc-dock-update', [
                'id' => $this->editId,
                'name' => $this->name,
            ]);
            ...
            $response = Http::withToken($this->token)->post('http://192.168.128.193:8080/api/doc-dock-store', [
                'name' => $this->name,
            ]);
    ...
    {
        $response = Http::withToken($this->token)->post('http://192.168.128.193:8080/api/doc-dock/' . $ids);
    ...
    {
        $response = Http::withToken($this->token)->post('http://192.168.128.193:8080/api/doc-dock-del/' . $this->delId);
