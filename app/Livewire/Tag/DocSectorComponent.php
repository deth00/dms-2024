...
class DocSectorComponent extends Component
{
    use WithFileUploads;
    public $data = [], $count;
    ...
    public function mount(){
        ...
        $response = Http::withToken($this->token)->post('http://192.168.128.193:8080/api/tag-sector', [
            'qty' => $this->dataQ,
            'search' => $this->search,
        ]);
    ...
    {
        return view('livewire.tag.doc-sector-component');
    }
