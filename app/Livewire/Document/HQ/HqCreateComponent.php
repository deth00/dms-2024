...
class HqCreateComponent extends Component
{
    use WithFileUploads;
    ...
    public function mount($id)
    {
        ...
        $arr = explode(',', $role_id);
        // dd($this->user_organi);
        // $ori_tye = Cookie::get('organi_type');
        // $this->ori_ty = explode(',', $ori_tye);
        $this->hiddenId = $id;
        $this->type_id = $id;
        // dd($this->user_organi);
    ...
    public function render()
    {
        ...
        return view('livewire.document.h-q.hq-create-component');
    }
    ...
    public function store()
    {
        ...
        if ($this->type_id == 1 || $this->type_id == 2) {
            ...
            if ($documents['message'] == "success") {
                ...
                return redirect(route('document-hq', $this->type_id));
            } else {
