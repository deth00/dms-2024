    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    @if (!empty($data_ho['Ho-add']))
                        <div class="col-md-3">
                            <a class="btn btn-primary" href="{{ route('document-hq-create', $hiddenId) }}">
                                ...
                                <table border="1" width="100%">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            @if (!empty($data_ho['Ho-edit']) || !empty($data_ho['Ho-del']))
