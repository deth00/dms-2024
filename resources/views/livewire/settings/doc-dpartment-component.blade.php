            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ຂໍ້ມູນເອກະສານພາຍນອກ</li>
                    </ol>
                </div>
                <h4 class="page-title">ຂໍ້ມູນເອກະສານພາຍນອກ</h4>
            </div>
        </div>
    </div>
                    ...
                    <div id="cardCollpase1" class="collapse show">
                        <div wire:ignore.self>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <p>ຂໍ້ມູນເອກະສານພາຍນອກ</p>
                                            <input type="text"
                                                class="form-control @error('name') is-invalid @enderror"
                                                wire:model="name" placeholder="ຊື່ເອກະສານພາຍນອກ"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('docdock') }}" class="btn btn-danger">ລ້າງຂໍ້ມູນ</a>
