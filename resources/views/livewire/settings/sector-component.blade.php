            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ຂໍ້ມູນຂະແໜງ</li>
                    </ol>
                </div>
                <h4 class="page-title">ຂໍ້ມູນຂະແໜງ</h4>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group" wire:ignore>
                                        <select class="form-control select2" data-placeholder="ເລືອກສາຂາ" id="cate"
                                            wire:model="br_id">
                                            <option>ເລືອກສາຂາ</option>
                                            @foreach ($data_brn as $item)
                                ...
                                <div class="col-md-12">
                                    <p>ພະແນກ</p>
                                    <div class="form-group" wire:ignore>
                                        <select class="form-control select2" data-placeholder="ເລືອກສາຂາ" id="dep"
                                            wire:model="dep_id">
                                            <option>ເລືອກພະແນກ</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            wire:model="name" placeholder="ຊື່" wire:keydown.enter="store" require>
                                        @error('name')
                                            <span style="color: red" class="error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <table border="2" width="100%">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="p-2"> ຊື່ຂະແໜງ </th>
                                            <th class="p-2"> ຊື່ພະແນກ </th>
                                            <th class="p-2"> ຊື່ສາຂາ </th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>ລາຍລະອຽດ: <span class="text-danger">{{ $name }}</span></p>
                </div>
