            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ຂໍ້ມູນຕູ້ເອກະສານ</li>
                    </ol>
                </div>
                <h4 class="page-title">ຂໍ້ມູນຕູ້ເອກະສານ</h4>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <p>ຂໍ້ມູນຕູ້ເອກະສານ</p>
                                            <input type="text"
                                                class="form-control @error('name') is-invalid @enderror"
                                                wire:model="name" placeholder="ຊື່ຕູ້ເອກະສານ"
