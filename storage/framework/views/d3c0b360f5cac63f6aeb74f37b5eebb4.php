<div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <!--[if BLOCK]><![endif]--><?php if(!empty($data_role['viewDocc1-add'])): ?>
                    <div class="row">
                        <div class="col-md-12">
                            <a class="btn btn-primary" href="<?php echo e(route('document-secret-add')); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Project\Web\Font-End\dms-2024\resources\views/livewire/document/secret/secret-doc-component.blade.php ENDPATH**/ ?>