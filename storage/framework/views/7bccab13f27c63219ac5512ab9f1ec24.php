                                    ...
                                    <tbody>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr class="text-center">
                                                ...
                                                <?php if(!empty($data_CK0['CK-edit']) || !empty($data_CK0['CK-edit'])): ?>
                                                    <td class="p-2">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Project\Web\dms-2024\resources\views/livewire/document/secret/secret-doc-component.blade.php ENDPATH**/ ?>